...
そもそものきっかけとして、「エンジニアの登壇を応援する会」主催の「目標設定の技術を勉強する会#1」@<fn>{event}という勉強会が2019年1月に開催されました。そこでは、さまざまな目標設定に関する技術やノウハウが発表されました。
...
2019年9月、本書の底本となる同人版「ワンストップ目標設定の技術」が発行され、加筆修正を経て、本書が発行されるに至りました。（超）長期の目標設定などに関する記述を追加し、さらなるパワーアップを果たしたと信じております。これを機に当シリーズに出合った方は、ぜひほかの本も見てみてください。
