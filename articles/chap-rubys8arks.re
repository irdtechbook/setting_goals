...
人によっては家族と過ごす時間が一番とか、趣味が一番、それよりもとにかくでかい家を建てたいとかいろいろあると思います。

「やだなぁ」なことを書いた場合はどれが一番イヤかを考えて、「その嫌なことがなくなること」をまず目標にしてみましょう。

この章では「5000兆円ほしい」が一番やりたいことだったという仮定のもと話をすすめます。
...
立てた目標に対してやってみた結果を日次、週次、月次でふりかえりしていきます。
...
複数のものを平行してやってみて、一番うまくいった分野に時間や労力を集中させましょう。

新しく「やりたい！」というものが生まれたり、「本当にこれが重要なんだっけ？」と不安になることもあるかもしれません。

そういうときは、また一番のステップから順にやってみて人生の優先順位を修正しましょう。
...
自分の好きなエンターテイメントの世界が一番大切だと思ったのです。

かといって、趣味が一番だから、定時で帰れてそこそこの給料がもらえれば仕事はつまらなくてもいい、とも割り切れません。

自分が好きなエンターテイメント以上に、夢中になれる仕事を見つけたい。

自分の好きな作品が伝えてくれるメッセージのように、輝きながら生きていたい！

==={me4} それが叶えられるためには何をやるべきなのかを情報収集する
...
==={me5} すぐやれそうなもの、うまくいきそうなものから手をつける
まずは興味があったことを手当たりしだいやってみました。

 * インフォグラフィック：「たのしいインフォグラフィック入門」を読んでインフォグラフィックを作る。

//image[rubys8arks_infographic][はじめて作ったインフォグラフィック][scale=0.75]
...
3000文字書いて300ポイント（のちに失効）で27PV。「だったら自分でブログ記事にした方がまだ広告収入も閲覧数もあるわ」と思い、専業ライターの道をやめました。
...
==={me7} いろいろ試してうまくいったものを続ける。うまくいかなかったものはやめる
